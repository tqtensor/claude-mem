---
type: analysis
title: "Issue #1024: Orphan reaper fails on Windows: $_ PowerShell syntax error (regression from #517)"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-1024]]"
---
# Issue #1024: Orphan reaper fails on Windows: $_ PowerShell syntax error (regression from #517)

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/1024)
