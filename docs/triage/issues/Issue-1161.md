---
type: analysis
title: "Issue #1161: [Windows] Zombie bun worker blocks Claude Code startup — hangs for 60s+ on SessionStart"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-1161]]"
---
# Issue #1161: [Windows] Zombie bun worker blocks Claude Code startup — hangs for 60s+ on SessionStart

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/1161)
