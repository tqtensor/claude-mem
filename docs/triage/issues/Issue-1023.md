---
type: analysis
title: "Issue #1023: Zombie TCP socket on Windows blocks worker restart (regression from #415)"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-1023]]"
---
# Issue #1023: Zombie TCP socket on Windows blocks worker restart (regression from #415)

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/1023)
