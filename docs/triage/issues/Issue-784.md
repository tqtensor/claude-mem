---
type: analysis
title: "Issue #784: Internal memory agent output leaks to user on claude --continue"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-784]]"
---
# Issue #784: Internal memory agent output leaks to user on claude --continue

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/784)
