---
type: analysis
title: "Issue #1128: setup.sh: node_modules not restored after hard reset causes onnxruntime-common ENOENT"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-1128]]"
---
# Issue #1128: setup.sh: node_modules not restored after hard reset causes onnxruntime-common ENOENT

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/1128)
