---
type: analysis
title: "Issue #1155: chromadb missing from plugin/package.json - Chroma fails to start from cache"
created: 2026-02-19
tags:
  - triage
  - issue
...
related:
  ...
  - "[[Issue-1155]]"
---
# Issue #1155: chromadb missing from plugin/package.json - Chroma fails to start from cache

- Link: [GitHub](https://github.com/thedotmack/claude-mem/issues/1155)
