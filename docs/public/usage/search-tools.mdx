...
**Note**: When you don't specify a project, claude-mem automatically defaults to your most recently active project. This ensures search results are relevant to your current work without needing to explicitly provide the project name each time.
