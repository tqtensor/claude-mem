...
| `CLAUDE_CODE_PATH`            | _(auto-detect)_                 | Path to Claude Code executable. Auto-detects via PATH if not set. Set this if Claude is not in your PATH or if auto-detection fails. |
