...
export class OpenRouterAgent {
   ...
   */
  private prepareMessageMetadata(session: ActiveSession, message: { _persistentId: number; agentId?: string | null; agentType?: string | null; tool_name?: string; tool_input?: unknown }): void {
    // CLAIM-CONFIRM: Track message ID for confirmProcessed() after successful storage
    session.processingMessageIds.push(message._persistentId);
    // Parallel metadata array so ResponseProcessor can derive sourceMetadata (tool_name/source_url/command)
