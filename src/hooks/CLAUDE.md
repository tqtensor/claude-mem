...
| #35955 | " | 🔵 | User Message Hook Context Display Mechanism | ~369 |
| #35954 | " | 🔵 | New Hook Session Initialization Flow | ~393 |
| #35953 | " | 🔵 | Standard Hook Response Protocol | ~253 |
...
| #35894 | " | 🔵 | Context Hook Explicitly Exits With Code 0 On Success | ~355 |
| #35893 | " | 🔵 | New Hook Initializes Session And Starts SDK Agent Without Exit Code | ~382 |
| #35891 | 2:47 PM | 🔵 | STANDARD_HOOK_RESPONSE Signals Continue And Suppress Output | ~333 |
| #35889 | " | 🔵 | Summary Hook Outputs STANDARD_HOOK_RESPONSE On Success And Error | ~358 |
| #35888 | " | 🔵 | User Message Hook Exits With USER_MESSAGE_ONLY Code | ~313 |
...
| #35835 | " | 🔵 | Save Hook Uses Fire-and-Forget for Observations | ~394 |
| #35833 | 2:29 PM | 🔵 | New Hook Starts Memory Agent Asynchronously | ~404 |
| #35831 | " | 🔵 | User Message Hook Exits with Special Exit Code | ~348 |
| #35829 | " | 🔵 | Summary Hook Uses Fire-and-Forget HTTP Pattern | ~385 |
...
| #35201 | " | 🔵 | New Hook receives and processes cwd parameter | ~303 |
...
| #33416 | " | 🔵 | User message hook displays context to user but doesn't participate in session ID management | ~313 |
| #33408 | 10:04 PM | 🔵 | New-hook initializes sessions using primary Claude Code session_id | ~355 |
| #33405 | " | 🔵 | Claude-Mem hook system structure identified | ~289 |
</claude-mem-context>