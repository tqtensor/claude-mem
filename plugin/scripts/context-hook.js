...
`+JSON.stringify(a,null,2):n=" "+this.formatData(a));let R="";if(r){let{sessionId:g,sdkSessionId:S,correlationId:E,...p}=r;Object.keys(p).length>0&&(R=` {${Object.entries(p).map(([H,j])=>`${H}=${j}`).join(", ")}}`)}let N=`[${i}] [${c}] [${_}] ${b}${t}${R}${n}`;e===3?console.error(N):console.log(N)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}error(e,s,t,r){this.log(3,e,s,t,r)}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}timing(e,s,t,r){this.info(e,`\u23F1 ${s}`,r,{duration:`${t}ms`})}},k=new K;import{appendFileSync as he}from"fs";import{homedir as ge}from"os";import{join as Se}from"path";var fe=Se(ge(),".pm2","logs","claude-mem-worker-error.log");function l(d,e,s=""){let t=new Date().toISOString(),c=((new Error().stack?.split(`
`)??[])[2]??"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",b=`[${t}] [HAPPY-PATH-ERROR] [${_}] ${d}`;if(e!==void 0)try{b+=` ${JSON.stringify(e)}`}catch(n){b+=` [stringify error: ${n}]`}b+=`
`;try{he(fe,b)}catch{}return s}var $=class{db;constructor(){re(y),this.db=new Re(te),this.db.pragma("journal_mode = WAL"),this.db.pragma("synchronous = NORMAL"),this.db.pragma("foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.addEndlessModeStatsColumns(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.addToolUseIdColumn(),this.removeToolUseIdUniqueConstraint()}initializeSchema(){try{this.db.exec(`
