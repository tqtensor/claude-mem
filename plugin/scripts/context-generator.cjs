"use strict";var Rt=Object.create;var w=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var Ct=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ct(e))!Lt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Nt(e,n))||s.enumerable});return r};var D=(r,e,t)=>(t=r!=null?Rt(It(r)):{},le(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),Dt=r=>le(w({},"__esModule",{value:!0}),r);var Jt={};yt(Jt,{generateContext:()=>_e});module.exports=Dt(Jt);var bt=D(require("path"),1),ht=require("os"),Ot=require("fs");var Ae=require("bun:sqlite");var S=require("path"),Q=require("os"),P=require("fs");var Te=require("url");var I=require("fs"),v=require("path"),ge=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),Ee=(0,v.join)((0,ge.homedir)(),".claude-mem"),z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(Ee,"logs");(0,I.existsSync)(e)||(0,I.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(Ee,"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",E={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},_=new z;var xt={};function vt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Te.fileURLToPath)(xt.url))}var Mt=vt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Q.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),L=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Q.homedir)(),".claude"),ts=(0,S.join)(L,"plugins","marketplaces","thedotmack"),ss=(0,S.join)(N,"archives"),rs=(0,S.join)(N,"logs"),ns=(0,S.join)(N,"trash"),os=(0,S.join)(N,"backups"),is=(0,S.join)(N,"modes"),as=(0,S.join)(N,"settings.json"),fe=(0,S.join)(N,"claude-mem.db"),ds=(0,S.join)(N,"vector-db"),us=(0,S.join)(N,"observer-sessions"),cs=(0,S.join)(L,"settings.json"),ms=(0,S.join)(L,"commands"),_s=(0,S.join)(L,"CLAUDE.md");function Se(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,S.join)(Mt,"..")}var he=require("crypto");var kt=3e4;function X(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function H(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Oe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ft(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var j=class{db;constructor(e=fe){e!==":memory:"&&Se(N),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.addObservationMetadataColumn()}initializeSchema(){this.db.run(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a,d){let c=i??Date.now(),m=new Date(c).toISOString(),E=X(e,s.title,s.narrative),l=H(this.db,E,c);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let A=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d,c){let m=a??Date.now(),E=new Date(m).toISOString();return this.db.transaction(()=>{let g=[],A=this.db.prepare(`
      ...
      `);for(let p of s){let b=X(e,p.title,p.narrative),f=H(this.db,b,m);if(f){g.push(f.id);continue}let T=A.run(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,b,E,m,d||null,c?JSON.stringify(c):null);g.push(Number(T.lastInsertRowid))}let R=null;if(n){let b=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model, metadata)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let F=X(e,T.title,T.narrative),pe=H(this.db,F,l);if(pe){R.push(pe.id);continue}let At=p.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,F,g,l,m||null,E?JSON.stringify(E):null);R.push(Number(At.lastInsertRowid))}let b;if(n){let F=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ...
  `).all(e,...n,...i,...s?[s]:[],t.totalObservationCount)}function ie(r,e,t,s){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,...s?[s]:[],t.sessionCount+se)}function Me(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
