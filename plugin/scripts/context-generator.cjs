...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:g,correlationId:h,...l}=n;Object.keys(l).length>0&&(u=` {${Object.entries(l).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${_}${s}${u}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},p=new W;var Ct={};function Rt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,_e.fileURLToPath)(Ct.url))}var Nt=Rt(),A=I.get("CLAUDE_MEM_DATA_DIR"),y=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,de.homedir)(),".claude"),Vt=(0,b.join)(y,"plugins","marketplaces","thedotmack"),qt=(0,b.join)(A,"archives"),Kt=(0,b.join)(A,"logs"),Jt=(0,b.join)(A,"trash"),Qt=(0,b.join)(A,"backups"),zt=(0,b.join)(A,"modes"),Zt=(0,b.join)(A,"settings.json"),pe=(0,b.join)(A,"claude-mem.db"),es=(0,b.join)(A,"vector-db"),ts=(0,b.join)(A,"observer-sessions"),ss=(0,b.join)(y,"settings.json"),rs=(0,b.join)(y,"commands"),ns=(0,b.join)(y,"CLAUDE.md");function me(r){(0,ce.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(Nt,"..")}var le=require("crypto");var At=3e4;function Ee(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Te(r,e,t){let s=t-At;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var $=class{db;constructor(e=pe){e!==":memory:"&&me(A),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
...
`):null}function Dt(r,e,t,s,n,o){let i=[];o?i.push(...qe(r)):i.push(...Ue(r));let a=null,d="",_=!1;for(let m of e)if(m.type==="summary"){_&&(i.push(""),_=!1,a=null,d="");let u=m.data,T=nt(u.displayTime);o?i.push(...ze(u,T)):i.push(...Fe(u,T))}else{let u=m.data,T=at(u.files_modified,n,u.files_read),E=ot(u.created_at),g=E!==d,h=g?E:"";d=E;let l=t.has(u.id);if(T!==a&&(_&&i.push(""),o?i.push(...Ke(T)):i.push(...ke(T)),a=T,_=!0),l){let S=vt(u,s);o?i.push(...Qe(u,E,g,S,s)):(_&&!o&&(i.push(""),_=!1),i.push(...$e(u,h,S,s)),a=null)}else o?i.push(Je(u,E,g,s)):i.push(we(u,h,s))}return _&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,d]of i)o.push(...Dt(a,d,e,t,s,n));return o}function ct(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function _t(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,c.blue)),t.push(...U("Learned",r.learned,c.yellow)),t.push(...U("Completed",r.completed,c.green)),t.push(...U("Next Steps",r.next_steps,c.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function pt(r,e){return e?Ze(r):Pe(r)}function mt(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=ut.default.join((0,lt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ut(){try{return new $}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Et.unlinkSync)(xt)}catch(e){e instanceof Error&&p.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return p.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?tt(r):je(r)}function wt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...st(r,d,s,i));let _=t.slice(0,s.sessionCount),m=Ae(_,t),u=Z(e,m),T=Ie(e,s.fullObservationCount);a.push(...dt(u,T,s,n,i));let E=t[0],g=e[0];ct(s,E,g)&&a.push(..._t(E,i));let h=z(e,s,o,n);return a.push(...pt(h,i)),a.push(...mt(d,s,i)),a.join(`
`).trimEnd()}async function te(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=Se(s),o=r?.projects||[n],i=Ut();if(!i)return"";try{let a=o.length>1?Ne(i,o,t):J(i,n,t),d=o.length>1?Ce(i,o,t):Q(i,n,t);return a.length===0&&d.length===0?kt(n,e):wt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
