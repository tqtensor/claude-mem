"use strict";var It=Object.create;var w=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var vt=Object.getPrototypeOf,Dt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},fe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!Dt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Lt(e,n))||s.enumerable});return r};var I=(r,e,t)=>(t=r!=null?It(vt(r)):{},fe(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),Ut=r=>fe(w({},"__esModule",{value:!0}),r);var rs={};yt(rs,{generateContext:()=>Te});module.exports=Ut(rs);var Rt=I(require("path"),1),Nt=require("os"),Ct=require("fs");var re=require("bun:sqlite");var A=require("path"),J=require("os"),P=require("fs"),Se=require("url"),Pt={};function xt(){return typeof __dirname<"u"?__dirname:(0,A.dirname)((0,Se.fileURLToPath)(Pt.url))}var kt=xt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,A.join)((0,J.homedir)(),".claude-mem"),e=(0,A.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var M=$t(),Q=process.env.CLAUDE_CONFIG_DIR||(0,A.join)((0,J.homedir)(),".claude"),os=(0,A.join)(Q,"plugins","marketplaces","thedotmack"),is=(0,A.join)(M,"settings.json"),he=(0,A.join)(M,"claude-mem.db"),wt=(0,A.join)(M,"observer-sessions"),z=(0,A.basename)(wt);function Oe(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,A.join)(kt,"..")}var C=require("fs"),v=require("path"),Re=require("os"),Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),Ae=(0,v.join)((0,Re.homedir)(),".claude-mem"),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(Ae,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(Ae,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",T={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},m=new ee;var Me=require("crypto");var Ce=require("os"),Ie=I(require("path"),1);var G=require("fs"),F=I(require("path"),1),D={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Ne(r){let e=F.default.join(r,".git"),t;try{t=(0,G.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),D}if(!t.isFile())return D;let s;try{s=(0,G.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),D}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return D;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return D;let a=i[1],d=F.default.basename(r),c=F.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}function Le(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Ce.homedir)()):r}function Ft(r){if(!r||r.trim()==="")return m.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Le(r),t=Ie.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return m.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return m.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function te(r){let e=Ft(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Le(r),s=Ne(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function se(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var R="claude";function Gt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return R;let e=Gt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:R}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ht(r,e){return{customTitle:r,platformSource:e?L(e):void 0}}var H=class{db;constructor(e=he){e instanceof re.Database?this.db=e:(e!==":memory:"&&Oe(M),this.db=new re.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.renameSessionIdColumns(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropPendingMessagesTable()}dropPendingMessagesTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31)||(this.db.run("DROP TABLE IF EXISTS pending_messages"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()))}initializeSchema(){this.db.run(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Ht(n,o),c=d.platformSource??R,u=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),u=se(e,s.title,s.narrative),p=this.db.prepare(`
...
`}function Et(r,e,t,s){let n=[];return s?n.push(...tt(r)):n.push(...He(r)),s?n.push(...st()):n.push(...Xe()),s?n.push(...rt()):n.push(...je()),s?n.push(...nt()):n.push(...Be()),B(t)&&(s?n.push(...ot(e,t)):n.push(...We(e,t))),n}var le=I(require("path"),1);function Y(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Ee(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Tt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function pt(r,e){return le.default.isAbsolute(r)?le.default.relative(e,r):r}function gt(r,e,t){let s=Y(r);if(s.length>0)return pt(s[0],e);if(t){let n=Y(t);if(n.length>0)return pt(n[0],e)}return"General"}function qt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Tt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ft(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Y(r.facts).join(`
`):null}function Jt(r,e,t,s){let n=[];n.push(...Ke(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Ee(a.displayTime);n.push(...Je(a,d))}else{let a=i.data,d=pe(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=ft(a,s);n.push(...qe(a,u,p,s))}else n.push(Ye(a,u,s))}return n}function Qt(r,e,t,s,n){let o=[];o.push(...it(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,u=Ee(c.displayTime);o.push(...ut(c,u))}else{let c=d.data,u=gt(c.files_modified,n,c.files_read),T=pe(c.created_at),p=T!==a;a=T;let E=t.has(c.id);if(u!==i&&(o.push(...at(u)),i=u),E){let f=ft(c,s);o.push(..._t(c,T,p,f,s))}else o.push(dt(c,T,p,s))}return o.push(""),o}function zt(r,e,t,s,n,o){return o?Qt(r,e,t,s,n):Jt(r,e,t,s)}function St(r,e,t,s,n){let o=[],i=qt(r);for(let[a,d]of i)o.push(...zt(a,d,e,t,s,n));return o}function ht(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ot(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,_.blue)),t.push(...$("Learned",r.learned,_.yellow)),t.push(...$("Completed",r.completed,_.green)),t.push(...$("Next Steps",r.next_steps,_.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function bt(r,e){return e?ct(r):Qe(r)}function At(r,e,t){return!B(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?mt(r.totalDiscoveryTokens,r.totalReadTokens):ze(r.totalDiscoveryTokens,r.totalReadTokens)}var Zt=Rt.default.join((0,Nt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function es(){try{return new H}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ct.unlinkSync)(Zt)}catch(e){e instanceof Error?m.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):m.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return m.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function ts(r,e){return e?lt(r):Ze(r)}function ss(r,e,t,s,n,o,i){let a=[],d=de(e);a.push(...Et(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Pe(c,t),T=me(e,u),p=Fe(e,s.fullObservationCount);a.push(...St(T,p,s,n,i));let E=t[0],f=e[0];ht(s,E,f)&&a.push(...Ot(E,i));let h=ce(e,s,o,n);return a.push(...bt(h,i)),a.push(...At(d,s,i)),a.join(`
`).trimEnd()}async function Te(r,e=!1){let t=oe(),s=r?.cwd??process.cwd(),n=te(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=es();if(!a)return"";try{let d=o.length>1?$e(a,o,t):_e(a,i,t),c=o.length>1?we(a,o,t):ue(a,i,t);return d.length===0&&c.length===0?ts(i,e):ss(i,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
