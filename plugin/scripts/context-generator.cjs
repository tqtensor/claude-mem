"use strict";var Et=Object.create;var U=Object.defineProperty;var Tt=Object.getOwnPropertyDescriptor;var gt=Object.getOwnPropertyNames;var ft=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var St=(r,e)=>{for(var t in e)U(r,t,{get:e[t],enumerable:!0})},de=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of gt(e))!bt.call(r,n)&&n!==t&&U(r,n,{get:()=>e[n],enumerable:!(s=Tt(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Et(ft(r)):{},de(e||!r||!r.__esModule?U(t,"default",{value:r,enumerable:!0}):t,r)),ht=r=>de(U({},"__esModule",{value:!0}),r);var $t={};St($t,{generateContext:()=>ae});module.exports=ht($t);var _t=y(require("path"),1),mt=require("os"),ut=require("fs");var Ee=require("bun:sqlite");var S=require("path"),K=require("os"),k=require("fs");var A=require("fs"),v=require("path"),pe=require("os"),q=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(q||{}),ce=(0,v.join)((0,pe.homedir)(),".claude-mem"),V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(ce,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(ce,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},_=new V;function Ot(){if(typeof __dirname<"u")return __dirname;if(typeof __filename<"u")return(0,S.dirname)(__filename);throw new Error("Cannot determine __dirname: CJS globals unavailable")}var Rt=Ot();function Ct(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,K.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,k.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=Ct(),I=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,K.homedir)(),".claude"),Gt=(0,S.join)(I,"plugins","marketplaces","thedotmack"),Ht=(0,S.join)(C,"archives"),Bt=(0,S.join)(C,"logs"),Wt=(0,S.join)(C,"trash"),Yt=(0,S.join)(C,"backups"),qt=(0,S.join)(C,"modes"),Vt=(0,S.join)(C,"settings.json"),_e=(0,S.join)(C,"claude-mem.db"),Kt=(0,S.join)(C,"vector-db"),Jt=(0,S.join)(C,"observer-sessions"),Qt=(0,S.join)(I,"settings.json"),zt=(0,S.join)(I,"commands"),Zt=(0,S.join)(I,"CLAUDE.md");function me(r){(0,k.mkdirSync)(r,{recursive:!0})}function ue(){return(0,S.join)(Rt,"..")}var le=require("crypto");var Nt=3e4;function w(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function $(r,e,t){let s=t-Nt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var F=class{db;constructor(e=_e){e!==":memory:"&&me(C),this.db=new Ee.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),p=new Date(d).toISOString();return this.db.transaction(()=>{let l=[],T=this.db.prepare(`
      ...
      `);for(let f of s){let R=w(e,f.title,f.narrative),u=$(this.db,R,d);if(u){l.push(u.id);continue}let b=T.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,R,p,d);l.push(Number(b.lastInsertRowid))}let E=null;if(n){let R=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let g=w(e,b.title,b.narrative),h=$(this.db,g,m);if(h){E.push(h.id);continue}let lt=f.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,g,l,m);E.push(Number(lt.lastInsertRowid))}let R;if(n){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
`}function tt(r,e,t,s){let n=[];return s?n.push(...Ge(r)):n.push(...ye(r)),s?n.push(...He()):n.push(...ve()),s?n.push(...Be()):n.push(...Le()),s?n.push(...We()):n.push(...Me()),G(t)&&(s?n.push(...Ye(e,t)):n.push(...De(e,t))),n}var ne=y(require("path"),1);function Y(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function oe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ie(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function st(r,e){return ne.default.isAbsolute(r)?ne.default.relative(e,r):r}function nt(r,e,t){let s=Y(r);if(s.length>0)return st(s[0],e);if(t){let n=Y(t);if(n.length>0)return st(n[0],e)}return"General"}function vt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=rt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ot(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Y(r.facts).join(`
`):null}function Lt(r,e,t,s){let n=[];n.push(...xe(r));let o="";for(let i of e)if(i.type==="summary"){o="";let a=i.data,d=oe(a.displayTime);n.push(...$e(a,d))}else{let a=i.data,d=ie(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let T=ot(a,s);n.push(...we(a,m,T,s))}else n.push(ke(a,m,s))}return n}function Mt(r,e,t,s,n){let o=[];o.push(...qe(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,m=oe(p.displayTime);o.push(...Qe(p,m))}else{let p=d.data,m=nt(p.files_modified,n,p.files_read),l=ie(p.created_at),T=l!==a;a=l;let E=t.has(p.id);if(m!==i&&(o.push(...Ve(m)),i=m),E){let f=ot(p,s);o.push(...Je(p,l,T,f,s))}else o.push(Ke(p,l,T,s))}return o.push(""),o}function Dt(r,e,t,s,n,o){return o?Mt(r,e,t,s,n):Lt(r,e,t,s)}function it(r,e,t,s,n){let o=[],i=vt(r);for(let[a,d]of i)o.push(...Dt(a,d,e,t,s,n));return o}function at(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function dt(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,c.blue)),t.push(...x("Learned",r.learned,c.yellow)),t.push(...x("Completed",r.completed,c.green)),t.push(...x("Next Steps",r.next_steps,c.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function ct(r,e){return e?ze(r):Fe(r)}function pt(r,e,t){return!G(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ze(r.totalDiscoveryTokens,r.totalReadTokens):Pe(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=_t.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ut(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,ut.unlinkSync)(xt)}catch(e){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?et(r):Xe(r)}function wt(r,e,t,s,n,o,i){let a=[],d=Z(e);a.push(...tt(r,d,s,i));let p=t.slice(0,s.sessionCount),m=Ne(p,t),l=re(e,m),T=Ae(e,s.fullObservationCount);a.push(...it(l,T,s,n,i));let E=t[0],f=e[0];at(s,E,f)&&a.push(...dt(E,i));let R=se(e,s,o,n);return a.push(...ct(R,i)),a.push(...pt(d,s,i)),a.join(`
`).trimEnd()}async function ae(r,e=!1){let t=J(),s=r?.cwd??process.cwd(),n=ge(s),o=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let i=Ut();if(!i)return"";try{let a=o.length>1?Re(i,o,t):ee(i,n,t),d=o.length>1?Ce(i,o,t):te(i,n,t);return a.length===0&&d.length===0?kt(n,e):wt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
