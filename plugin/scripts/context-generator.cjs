...
`}function Je(r,e,t,s){let n=[];return s?n.push(...we(r)):n.push(...Ce(r)),s?n.push(...Fe()):n.push(...Re()),s?n.push(...Pe()):n.push(...Ie()),s?n.push(...je()):n.push(...Ne()),w(t)&&(s?n.push(...Xe(e,t)):n.push(...ye(e,t))),n}var z=v(require("path"),1);function X(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ze(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ze(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function et(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Qe(r,e){return z.default.isAbsolute(r)?z.default.relative(e,r):r}function tt(r,e,t){let s=X(r);if(s.length>0)return Qe(s[0],e);if(t){let n=X(t);if(n.length>0)return Qe(n[0],e)}return"General"}function Ct(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=et(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Rt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?X(r.facts).join(`
`):null}function It(r,e,t,s,n,o){let i=[];o?i.push(...Be(r)):i.push(...Ae(r));let a=null,d="",m=!1;for(let u of e)if(u.type==="summary"){m&&(i.push(""),m=!1,a=null,d="");let l=u.data,g=ze(l.displayTime);o?i.push(...Ye(l,g)):i.push(...De(l,g))}else{let l=u.data,g=tt(l.files_modified,n,l.files_read),E=Ze(l.created_at),T=E!==d,b=T?E:"";d=E;let _=t.has(l.id);if(g!==a&&(m&&i.push(""),o?i.push(...Ge(g)):i.push(...ve(g)),a=g,m=!0),_){let S=Rt(l,s);o?i.push(...We(l,E,T,S,s)):(m&&!o&&(i.push(""),m=!1),i.push(...Me(l,b,S,s)),a=null)}else o?i.push(He(l,E,T,s)):i.push(Le(l,b,s))}return m&&i.push(""),i}function st(r,e,t,s,n){let o=[],i=Ct(r);for(let[a,d]of i)o.push(...It(a,d,e,t,s,n));return o}function rt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function nt(r,e){let t=[];return e?(t.push(...D("Investigated",r.investigated,p.blue)),t.push(...D("Learned",r.learned,p.yellow)),t.push(...D("Completed",r.completed,p.green)),t.push(...D("Next Steps",r.next_steps,p.magenta))):(t.push(...M("Investigated",r.investigated)),t.push(...M("Learned",r.learned)),t.push(...M("Completed",r.completed)),t.push(...M("Next Steps",r.next_steps))),t}function ot(r,e){return e?Ve(r):xe(r)}function it(r,e,t){return!w(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?qe(r.totalDiscoveryTokens,r.totalReadTokens):ke(r.totalDiscoveryTokens,r.totalReadTokens)}var Nt=at.default.join((0,dt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function yt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,pt.unlinkSync)(Nt)}catch(e){c.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return c.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function At(r,e){return e?Ke(r):$e(r)}function vt(r,e,t,s,n,o,i){let a=[],d=V(e);a.push(...Je(r,d,s,i));let m=t.slice(0,s.sessionCount),u=he(m,t),l=Q(e,u),g=be(e,s.fullObservationCount);a.push(...st(l,g,s,n,i));let E=t[0],T=e[0];rt(s,E,T)&&a.push(...nt(E,i));let b=J(e,s,o,n);return a.push(...ot(b,i)),a.push(...it(d,s,i)),a.join(`
`).trimEnd()}async function Z(r,e=!1){let t=W(),s=r?.cwd??process.cwd(),n=le(s),o=yt();if(!o)return"";try{let i=q(o,n,t),a=K(o,n,t);return i.length===0&&a.length===0?At(n,e):vt(n,i,a,t,s,r?.session_id,e)}finally{o.close()}}0&&(module.exports={generateContext});
