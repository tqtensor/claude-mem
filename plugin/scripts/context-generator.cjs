"use strict";var Ct=Object.create;var P=Object.defineProperty;var It=Object.getOwnPropertyDescriptor;var Lt=Object.getOwnPropertyNames;var Mt=Object.getPrototypeOf,vt=Object.prototype.hasOwnProperty;var Dt=(r,e)=>{for(var t in e)P(r,t,{get:e[t],enumerable:!0})},Se=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Lt(e))!vt.call(r,n)&&n!==t&&P(r,n,{get:()=>e[n],enumerable:!(s=It(e,n))||s.enumerable});return r};var I=(r,e,t)=>(t=r!=null?Ct(Mt(r)):{},Se(e||!r||!r.__esModule?P(t,"default",{value:r,enumerable:!0}):t,r)),yt=r=>Se(P({},"__esModule",{value:!0}),r);var ss={};Dt(ss,{generateContext:()=>ge});module.exports=yt(ss);var At=I(require("path"),1),Rt=require("os"),Nt=require("fs");var ne=require("bun:sqlite");var A=require("path"),Q=require("os"),F=require("fs"),he=require("url"),wt={};function Ut(){return typeof __dirname<"u"?__dirname:(0,A.dirname)((0,he.fileURLToPath)(wt.url))}var xt=Ut();function kt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,A.join)((0,Q.homedir)(),".claude-mem"),e=(0,A.join)(r,"settings.json");try{if((0,F.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var v=kt(),z=process.env.CLAUDE_CONFIG_DIR||(0,A.join)((0,Q.homedir)(),".claude"),ns=(0,A.join)(z,"plugins","marketplaces","thedotmack"),os=(0,A.join)(v,"settings.json"),Oe=(0,A.join)(v,"claude-mem.db"),$t=(0,A.join)(v,"observer-sessions"),Z=(0,A.basename)($t);function be(r){(0,F.mkdirSync)(r,{recursive:!0})}function Ae(){return(0,A.join)(xt,"..")}var C=require("fs"),D=require("path"),Ne=require("os"),ee=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n))(ee||{}),Re=(0,D.join)((0,Ne.homedir)(),".claude-mem"),te=class{level=null;logFilePath=null;logFileInitialized=!1;ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,D.join)(Re,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,D.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,D.join)(Re,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ee[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let T="";if(n){let{sessionId:E,memorySessionId:f,correlationId:h,...l}=n;Object.keys(l).length>0&&(T=` {${Object.entries(l).map(([S,g])=>`${S}=${g}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${c}${s}${T}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",T={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},m=new te;var ve=require("crypto");var Ie=require("os"),Le=I(require("path"),1);var H=require("fs"),G=I(require("path"),1),y={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Ce(r){let e=G.default.join(r,".git"),t;try{t=(0,H.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),y}if(!t.isFile())return y;let s;try{s=(0,H.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),y}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return y;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return y;let a=i[1],d=G.default.basename(r),c=G.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}function Me(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Ie.homedir)()):r}function Pt(r){if(!r||r.trim()==="")return m.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Me(r),t=Le.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return m.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return m.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function se(r){let e=Pt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Me(r),s=Ce(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function re(r,e,t){return(0,ve.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var R="claude";function Ft(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return R;let e=Ft(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:R}function De(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Gt(r,e){return{customTitle:r,platformSource:e?L(e):void 0}}var X=class{db;constructor(e=Oe){e instanceof ne.Database?this.db=e:(e!==":memory:"&&be(v),this.db=new ne.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.renameSessionIdColumns(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropPendingMessagesTable()}dropPendingMessagesTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31)||(this.db.run("DROP TABLE IF EXISTS pending_messages"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()))}initializeSchema(){this.db.run(`
    ...
    `).all(...u);if(!i)return E;let f=new Map(E.map(h=>[h.id,h]));return e.map(h=>f.get(h)).filter(h=>!!h)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),u=[...e],T=o?"AND s.project = ?":"";o&&u.push(o);let E=this.db.prepare(`
      ...
      ${a}
      ${d}
    `).all(...u);if(!i)return E;let f=new Map(E.map(h=>[h.id,h]));return e.map(h=>f.get(h)).filter(h=>!!h)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let l=`
...
`}function Tt(r,e,t,s){let n=[];return s?n.push(...rt(r)):n.push(...Be(r)),s?n.push(...nt()):n.push(...We()),s?n.push(...ot()):n.push(...Ke()),s?n.push(...it()):n.push(...Ve()),W(t)&&(s?n.push(...at(e,t)):n.push(...Ye(e,t))),n}function Yt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Xe(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function gt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?V(r.facts).join(`
`):null}function qt(r,e,t,s){let n=[];n.push(...qe(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=pe(a.displayTime);n.push(...Ze(a,d))}else{let a=i.data,d=Te(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=gt(a,s);n.push(...ze(a,u,p,s))}else n.push(Qe(a,u,s))}return n}function Jt(r,e,t,s,n){let o=[];o.push(...dt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,u=pe(c.displayTime);o.push(...mt(c,u))}else{let c=d.data,u=je(c.files_modified,n,c.files_read),T=Te(c.created_at),p=T!==a;a=T;let E=t.has(c.id);if(u!==i&&(o.push(..._t(u)),i=u),E){let f=gt(c,s);o.push(...ct(c,T,p,f,s))}else o.push(ut(c,T,p,s))}return o.push(""),o}function Qt(r,e,t,s,n,o){return o?Jt(r,e,t,s,n):qt(r,e,t,s)}function ft(r,e,t,s,n){let o=[],i=Yt(r);for(let[a,d]of i)o.push(...Qt(a,d,e,t,s,n));return o}function St(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ht(r,e){let t=[];return e?(t.push(...w("Investigated",r.investigated,_.blue)),t.push(...w("Learned",r.learned,_.yellow)),t.push(...w("Completed",r.completed,_.green)),t.push(...w("Next Steps",r.next_steps,_.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function Ot(r,e){return e?lt(r):et(r)}function bt(r,e,t){return!W(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Et(r.totalDiscoveryTokens,r.totalReadTokens):tt(r.totalDiscoveryTokens,r.totalReadTokens)}var zt=At.default.join((0,Rt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Zt(){try{return new X}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Nt.unlinkSync)(zt)}catch(e){e instanceof Error?m.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):m.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return m.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function es(r,e){return e?pt(r):st(r)}function ts(r,e,t,s,n,o,i){let a=[],d=_e(e);a.push(...Tt(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Fe(c,t),T=le(e,u),p=Ge(e,s.fullObservationCount);a.push(...ft(T,p,s,n,i));let E=t[0],f=e[0];St(s,E,f)&&a.push(...ht(E,i));let h=me(e,s,o,n);return a.push(...Ot(h,i)),a.push(...bt(d,s,i)),a.join(`
`).trimEnd()}async function ge(r,e=!1){let t=ie(),s=r?.cwd??process.cwd(),n=se(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Zt();if(!a)return"";try{let d=o.length>1?we(a,o,t):ue(a,i,t),c=o.length>1?Pe(a,o,t):ce(a,i,t);return d.length===0&&c.length===0?es(i,e):ts(i,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
