...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let _="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,...l}=n;Object.keys(l).length>0&&(_=` {${Object.entries(l).map(([S,N])=>`${S}=${N}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${_}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",_={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,_,n),o}},m=new W;var Ct={};function Ot(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,me.fileURLToPath)(Ct.url))}var Rt=Ot(),A=I.get("CLAUDE_MEM_DATA_DIR"),y=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,pe.homedir)(),".claude"),Yt=(0,b.join)(y,"plugins","marketplaces","thedotmack"),Vt=(0,b.join)(A,"archives"),qt=(0,b.join)(A,"logs"),Kt=(0,b.join)(A,"trash"),Jt=(0,b.join)(A,"backups"),zt=(0,b.join)(A,"modes"),Qt=(0,b.join)(A,"settings.json"),ue=(0,b.join)(A,"claude-mem.db"),Zt=(0,b.join)(A,"vector-db"),es=(0,b.join)(A,"observer-sessions"),ts=(0,b.join)(y,"settings.json"),ss=(0,b.join)(y,"commands"),rs=(0,b.join)(y,"CLAUDE.md");function _e(r){(0,ce.mkdirSync)(r,{recursive:!0,mode:448})}function le(){return(0,b.join)(Rt,"..")}var $=class{db;constructor(e=ue){e!==":memory:"&&_e(A),this.db=new Ee.Database(e),e!==":memory:"&&(0,ge.chmodSync)(e,384),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",u=n?`LIMIT ${n}`:"",_=e.map(()=>"?").join(","),g=[...e],E=[];if(o&&(E.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");E.push(`type IN (${l})`),g.push(...i)}else E.push("type = ?"),g.push(i);if(a){let l=Array.isArray(a)?a:[a],f=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...l),E.push(`(${f.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],f=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(S=>{g.push(`%${S}%`,`%${S}%`)}),E.push(`(${f.join(" OR ")})`)}let T=E.length>0?`WHERE id IN (${_}) AND ${E.join(" AND ")}`:`WHERE id IN (${_})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${T}
...
`):null}function Lt(r,e,t,s,n,o){let i=[];o?i.push(...Ve(r)):i.push(...xe(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let _=u.data,g=rt(_.displayTime);o?i.push(...ze(_,g)):i.push(...$e(_,g))}else{let _=u.data,g=it(_.files_modified,n,_.files_read),E=nt(_.created_at),T=E!==d,h=T?E:"";d=E;let l=t.has(_.id);if(g!==a&&(c&&i.push(""),o?i.push(...qe(g)):i.push(...ke(g)),a=g,c=!0),l){let f=vt(_,s);o?i.push(...Je(_,E,T,f,s)):(c&&!o&&(i.push(""),c=!1),i.push(...we(_,h,f,s)),a=null)}else o?i.push(Ke(_,E,T,s)):i.push(Ue(_,h,s))}return c&&i.push(""),i}function at(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,d]of i)o.push(...Lt(a,d,e,t,s,n));return o}function dt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function pt(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,p.blue)),t.push(...k("Learned",r.learned,p.yellow)),t.push(...k("Completed",r.completed,p.green)),t.push(...k("Next Steps",r.next_steps,p.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function ct(r,e){return e?Qe(r):Fe(r)}function mt(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ze(r.totalDiscoveryTokens,r.totalReadTokens):Pe(r.totalDiscoveryTokens,r.totalReadTokens)}var Dt=ut.default.join((0,_t.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function xt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,lt.unlinkSync)(Dt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?et(r):Xe(r)}function Ut(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...tt(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ne(c,t),_=Z(e,u),g=Ae(e,s.fullObservationCount);a.push(...at(_,g,s,n,i));let E=t[0],T=e[0];dt(s,E,T)&&a.push(...pt(E,i));let h=Q(e,s,o,n);return a.push(...ct(h,i)),a.push(...mt(d,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=fe(s),o=r?.projects||[n],i=xt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):J(i,n,t),d=o.length>1?Ce(i,o,t):z(i,n,t);return a.length===0&&d.length===0?kt(n,e):Ut(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
