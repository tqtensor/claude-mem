"use strict";var Rt=Object.create;var w=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of It(e))!Lt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Nt(e,n))||s.enumerable});return r};var D=(r,e,t)=>(t=r!=null?Rt(Ct(r)):{},le(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),Dt=r=>le(w({},"__esModule",{value:!0}),r);var Jt={};yt(Jt,{generateContext:()=>_e});module.exports=Dt(Jt);var bt=D(require("path"),1),ht=require("os"),Ot=require("fs");var Ae=require("bun:sqlite");var S=require("path"),Q=require("os"),P=require("fs");var Te=require("url");var C=require("fs"),M=require("path"),ge=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),Ee=(0,M.join)((0,ge.homedir)(),".claude-mem"),z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,M.join)(Ee,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,M.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,M.join)(Ee,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=J[e].padEnd(5),d=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let _="";o!=null&&(o instanceof Error?_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?_=`
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let E="";if(n){let{sessionId:g,memorySessionId:A,correlationId:R,...p}=n;Object.keys(p).length>0&&(E=` {${Object.entries(p).map(([f,T])=>`${f}=${T}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${c}${s}${E}${_}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",E={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},m=new z;var xt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Te.fileURLToPath)(xt.url))}var vt=Mt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Q.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),L=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Q.homedir)(),".claude"),ts=(0,S.join)(L,"plugins","marketplaces","thedotmack"),ss=(0,S.join)(N,"archives"),rs=(0,S.join)(N,"logs"),ns=(0,S.join)(N,"trash"),os=(0,S.join)(N,"backups"),is=(0,S.join)(N,"modes"),as=(0,S.join)(N,"settings.json"),fe=(0,S.join)(N,"claude-mem.db"),ds=(0,S.join)(N,"vector-db"),us=(0,S.join)(N,"observer-sessions"),cs=(0,S.join)(L,"settings.json"),ms=(0,S.join)(L,"commands"),_s=(0,S.join)(L,"CLAUDE.md");function Se(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,S.join)(vt,"..")}var he=require("crypto");var kt=3e4;function H(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function X(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Oe(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ft(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var j=class{db;constructor(e=fe){e!==":memory:"&&Se(N),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addUserPromptsUniqueIndex(),this.addObservationModelColumns(),this.addObservationMetadataColumn()}initializeSchema(){this.db.run(`
    ...
    ) WHERE json_extract(metadata, '$.tool_name') IS NOT NULL`),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(27,new Date().toISOString()))}updateMemorySessionId(e,t){this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Ft(n,o),c=d.platformSource??h,_=this.db.prepare(`
    ...
    `).get(e);if(_){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let l=_.platform_source?.trim()?y(_.platform_source):void 0;if(!l)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o);return i.changes===0?this.db.prepare("SELECT id FROM user_prompts WHERE content_session_id = ? AND prompt_number = ? LIMIT 1").get(e,t)?.id??0:i.lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a,d){let c=i??Date.now(),_=new Date(c).toISOString(),E=H(e,s.title,s.narrative),l=X(this.db,E,c);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let A=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, metadata)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,E,_,c,a||null,d?JSON.stringify(d):null);return{id:Number(A.lastInsertRowid),createdAtEpoch:c}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),_=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d,c){let _=a??Date.now(),E=new Date(_).toISOString();return this.db.transaction(()=>{let g=[],A=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, metadata)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let p of s){let b=H(e,p.title,p.narrative),f=X(this.db,b,_);if(f){g.push(f.id);continue}let T=A.run(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,b,E,_,d||null,c?JSON.stringify(c):null);g.push(Number(T.lastInsertRowid))}let R=null;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,E,_);R=Number(b.lastInsertRowid)}return{observationIds:g,summaryId:R,createdAtEpoch:_}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,c,_,E){let l=c??Date.now(),g=new Date(l).toISOString();return this.db.transaction(()=>{let R=[],p=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, metadata)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let F=H(e,T.title,T.narrative),pe=X(this.db,F,l);if(pe){R.push(pe.id);continue}let At=p.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,F,g,l,_||null,E?JSON.stringify(E):null);R.push(Number(At.lastInsertRowid))}let b;if(n){let F=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      ...
      `).run(l,o),{observationIds:R,summaryId:b,createdAtEpoch:l}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),c=[...e],_=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&c.push(o),this.db.prepare(`
    ...
    `).run(e.memory_session_id,e.project,e.text,e.type,e.title,e.subtitle,e.facts,e.narrative,e.concepts,e.files_read,e.files_modified,e.prompt_number,e.discovery_tokens||0,e.created_at,e.created_at_epoch,e.metadata||null).lastInsertRowid}}rebuildObservationsFTSIndex(){this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run("INSERT INTO observations_fts(observations_fts) VALUES('rebuild')")}importUserPrompt(e){let t=this.db.prepare(`
  ...
  `).all(...e,...n,...i,...s?[s]:[],t.totalObservationCount)}function Ue(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...s?[s]:[],t.sessionCount+se)}function Ht(r){return r.replace(/\//g,"-")}function Xt(r){try{if(!(0,Y.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,Y.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(De,"").trim(),a){s=a;break}}}catch(o){m.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return m.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function ae(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Ht(s),a=Me.default.join(L,"projects",i,`${o}.jsonl`);return Xt(a)}function xe(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function de(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function ke(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function $e(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Fe(r){return[`# $CMEM ${r} ${$e()}`,""]}function we(){return[`Legend: \u{1F3AF}session ${O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Pe(){return[]}function He(){return[]}function Xe(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function je(r){return[`### ${r}`]}function Ge(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Be(r,e,t){let s=r.title||"Untitled",n=O.getInstance().getTypeIcon(r.type),o=e?Ge(e):'"';return`${r.id} ${o} ${n} ${s}`}function We(r,e,t,s){let n=[],o=r.title||"Untitled",i=O.getInstance().getTypeIcon(r.type),a=e?Ge(e):'"',{readTokens:d,discoveryDisplay:c}=x(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let _=[];return s.showReadTokens&&_.push(`~${d}t`),s.showWorkTokens&&_.push(c),_.length>0&&n.push(_.join(" ")),n.push(""),n}function Ye(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function k(r,e){return e?[`**${r}**: ${e}`,""]:[]}function qe(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Ve(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Ke(r){return`# $CMEM ${r} ${$e()}

No previous sessions found.`}function Je(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function ze(r){return["",`${u.bright}${u.cyan}[${r}] recent context, ${Je()}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function Qe(){let e=O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${u.dim}Legend: session-request | ${e}${u.reset}`,""]}function Ze(){return[`${u.bright}Column Key${u.reset}`,`${u.dim}  Read: Tokens to read this observation (cost to learn it now)${u.reset}`,`${u.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${u.reset}`,""]}function et(){return[`${u.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${u.reset}`,"",`${u.dim}When you need implementation details, rationale, or debugging context:${u.reset}`,`${u.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${u.reset}`,`${u.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${u.reset}`,`${u.dim}  - Trust this index over re-reading code for past decisions and learnings${u.reset}`,""]}function tt(r,e){let t=[];if(t.push(`${u.bright}${u.cyan}Context Economics${u.reset}`),t.push(`${u.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${u.reset}`),t.push(`${u.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${u.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${u.green}${s}${u.reset}`)}return t.push(""),t}function st(r){return[`${u.bright}${u.cyan}${r}${u.reset}`,""]}function rt(r){return[`${u.dim}${r}${u.reset}`]}function nt(r,e,t,s){let n=r.title||"Untitled",o=O.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=x(r,s),c=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),_=s.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",E=s.showWorkTokens&&a>0?`${u.dim}(${d} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${r.id}${u.reset}  ${c}  ${o}  ${n} ${_} ${E}`}function ot(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=O.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:_}=x(r,n),E=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),l=n.showReadTokens&&d>0?`${u.dim}(~${d}t)${u.reset}`:"",g=n.showWorkTokens&&c>0?`${u.dim}(${_} ${c.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${r.id}${u.reset}  ${E}  ${a}  ${u.bright}${i}${u.reset}`),s&&o.push(`    ${u.dim}${s}${u.reset}`),(l||g)&&o.push(`    ${l} ${g}`),o.push(""),o}function it(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${u.yellow}#S${r.id}${u.reset} ${t}`,""]}function $(r,e,t){return e?[`${t}${r}:${u.reset} ${e}`,""]:[]}function at(r){return r.assistantMessage?["","---","",`${u.bright}${u.magenta}Previously${u.reset}`,"",`${u.dim}A: ${r.assistantMessage}${u.reset}`,""]:[]}function dt(r,e){let t=Math.round(r/1e3);return["",`${u.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${u.reset}`]}function ut(r){return`
${u.bright}${u.cyan}[${r}] recent context, ${Je()}${u.reset}
${u.gray}${"\u2500".repeat(60)}${u.reset}

${u.dim}No previous sessions found for this project yet.${u.reset}
`}function ct(r,e,t,s){let n=[];return s?n.push(...ze(r)):n.push(...Fe(r)),s?n.push(...Qe()):n.push(...we()),s?n.push(...Ze()):n.push(...Pe()),s?n.push(...et()):n.push(...He()),W(t)&&(s?n.push(...tt(e,t)):n.push(...Xe(e,t))),n}var ue=D(require("path"),1);function K(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ce(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function me(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function _t(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function mt(r,e){return ue.default.isAbsolute(r)?ue.default.relative(e,r):r}function pt(r,e,t){let s=K(r);if(s.length>0)return mt(s[0],e);if(t){let n=K(t);if(n.length>0)return mt(n[0],e)}return"General"}function jt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=_t(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?K(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...je(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ce(a.displayTime);n.push(...Ye(a,d))}else{let a=i.data,d=me(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let l=lt(a,s);n.push(...We(a,_,l,s))}else n.push(Be(a,_,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...st(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,_=ce(c.displayTime);o.push(...it(c,_))}else{let c=d.data,_=pt(c.files_modified,n,c.files_read),E=me(c.created_at),l=E!==a;a=E;let g=t.has(c.id);if(_!==i&&(o.push(...rt(_)),i=_),g){let A=lt(c,s);o.push(...ot(c,E,l,A,s))}else o.push(nt(c,E,l,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=jt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Tt(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,u.blue)),t.push(...$("Learned",r.learned,u.yellow)),t.push(...$("Completed",r.completed,u.green)),t.push(...$("Next Steps",r.next_steps,u.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function ft(r,e){return e?at(r):qe(r)}function St(r,e,t){return!W(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):Ve(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qt(){try{return new j}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ot.unlinkSync)(Yt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Vt(r,e){return e?ut(r):Ke(r)}function Kt(r,e,t,s,n,o,i){let a=[],d=ne(e);a.push(...ct(r,d,s,i));let c=t.slice(0,s.sessionCount),_=xe(c,t),E=de(e,_),l=ke(e,s.fullObservationCount);a.push(...Et(E,l,s,n,i));let g=t[0],A=e[0];gt(s,g,A)&&a.push(...Tt(g,i));let R=ae(e,s,o,n);return a.push(...ft(R,i)),a.push(...St(d,s,i)),a.join(`
`).trimEnd()}async function _e(r,e=!1){let t=te(),s=r?.cwd??process.cwd(),n=Ie(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=qt();if(!a)return"";try{let d=i.length>1?ve(a,i,t,o):oe(a,n,t,o),c=i.length>1?Ue(a,i,t,o):ie(a,n,t,o);return d.length===0&&c.length===0?Vt(n,e):Kt(n,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
