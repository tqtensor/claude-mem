#!/usr/bin/env node
import{stdin as w}from"process";import{readFileSync as F,existsSync as X}from"fs";import J from"better-sqlite3";import{join as E,dirname as P,basename as pe}from"path";import{homedir as v}from"os";import{existsSync as me,mkdirSync as $}from"fs";import{fileURLToPath as W}from"url";function j(){return typeof __dirname<"u"?__dirname:P(W(import.meta.url))}var G=j(),b=process.env.CLAUDE_MEM_DATA_DIR||E(v(),".claude-mem"),N=process.env.CLAUDE_CONFIG_DIR||E(v(),".claude"),Te=E(b,"archives"),Se=E(b,"logs"),ge=E(b,"trash"),be=E(b,"backups"),Re=E(b,"settings.json"),A=E(b,"claude-mem.db"),he=E(b,"vector-db"),fe=E(N,"settings.json"),Oe=E(N,"commands"),Ne=E(N,"CLAUDE.md");function C(i){$(i,{recursive:!0})}function k(){return E(G,"..","..")}var I=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(I||{}),L=class{level;useColor;constructor(){let e=process.env.CLAUDE_MEM_LOG_LEVEL?.toUpperCase()||"INFO";this.level=I[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
