...
`+JSON.stringify(n,null,2):g=" "+this.formatData(n));let m="";if(r){let{sessionId:c,sdkSessionId:R,correlationId:u,...d}=r;Object.keys(d).length>0&&(m=` {${Object.entries(d).map(([b,T])=>`${b}=${T}`).join(", ")}}`)}let S=`[${i}] [${a}] [${p}] ${l}${t}${m}${g}`;e===3?console.error(S):console.log(S)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}error(e,s,t,r){this.log(3,e,s,t,r)}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}timing(e,s,t,r){this.info(e,`\u23F1 ${s}`,r,{duration:`${t}ms`})}},_=new X;import{appendFileSync as pe}from"fs";import{homedir as le}from"os";import{join as ue}from"path";var _e=ue(le(),".pm2","logs","claude-mem-worker-error.log");function E(o,e,s=""){let t=new Date().toISOString(),a=((new Error().stack?.split(`
