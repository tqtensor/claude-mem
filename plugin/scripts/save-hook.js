#!/usr/bin/env node
import{stdin as q}from"process";import{readFileSync as Ie}from"fs";import se from"better-sqlite3";import{join as O,dirname as z,basename as Ae}from"path";import{homedir as H}from"os";import{existsSync as Me,mkdirSync as V}from"fs";import{fileURLToPath as Q}from"url";function Z(){return typeof __dirname<"u"?__dirname:z(Q(import.meta.url))}var ee=Z(),h=process.env.CLAUDE_MEM_DATA_DIR||O(H(),".claude-mem"),k=process.env.CLAUDE_CONFIG_DIR||O(H(),".claude"),Ue=O(h,"archives"),we=O(h,"logs"),Fe=O(h,"trash"),D=O(h,"backups"),Be=O(h,"settings.json"),P=O(h,"claude-mem.db"),He=O(h,"vector-db"),Pe=O(k,"settings.json"),Xe=O(k,"commands"),$e=O(k,"CLAUDE.md");function I(n){V(n,{recursive:!0})}function X(){return O(ee,"..","..")}var M=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARN=2]="WARN",i[i.ERROR=3]="ERROR",i[i.SILENT=4]="SILENT",i))(M||{}),x=class{level;useColor;constructor(){let e=process.env.CLAUDE_MEM_LOG_LEVEL?.toUpperCase()||"INFO";this.level=M[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
